...
fn main() {
    ...
    let rook_vent_test_square = Square { piece: Some(PieceKind::Rook(Rook { color: Color::White })), square_type: SquareType::Vent, conditions: vec![] };
...
`PieceKind` could have a `symbol_to_piece` method, maybe

```rs
impl PieceKind {
    fn symbol_to_piece(symbol: char) -> Option<PieceKind> {
        match symbol {
            'P' => Some(PieceKind::Pawn(Pawn { Color::White })),
            'R' => Some(PieceKind::Rook(Rook { Color::White })),
            'N' => Some(PieceKind::Knight(Knight { Color::White })),
            'B' => Some(PieceKind::Bishop(Bishop { Color::White })),
            'Q' => Some(PieceKind::Queen(Queen { Color::White })),
            'K' => Some(PieceKind::King(King { Color::White })),
            'p' => Some(PieceKind::Pawn(Pawn { Color::Black })),
            'r' => Some(PieceKind::Rook(Rook { Color::Black })),
            'n' => Some(PieceKind::Knight(Knight { Color::Black })),
            'b' => Some(PieceKind::Bishop(Bishop { Color::Black })),
            'q' => Some(PieceKind::Queen(Queen { Color::Black })),
            'k' => Some(PieceKind::King(King { Color::Black })),
            _ => None,
        }
    }
}
